...
const (
	pkgLegacySupport = "github.com/r2d2-ai/legacybridge"
)

func InstallLegacySupport(project common.AppProject) error {
	//todo make sure we only install once
	pkgLegacySupportImport, err := util.NewAIflowImportFromPath(pkgLegacySupport)
	if err != nil {
		return err
	}
...
import (
	"github.com/r2d2-ai/legacybridge"
	"github.com/TIBCOSoftware/AIflow_-lib/core/activity"
)
...
import (
	"github.com/r2d2-ai/legacybridge"
	"github.com/TIBCOSoftware/AIflow_-lib/core/trigger"
)
